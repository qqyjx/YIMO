...
CREATE TABLE IF NOT EXISTS `object_lifecycle_history` (
    ...
    `object_id` INT NOT NULL COMMENT '对象ID',
    `lifecycle_stage` ENUM('Planning','Design','Construction','Operation') NOT NULL COMMENT '生命周期阶段（统一4阶段）',
...
('RR_COST_BUDGET', '费用超预算预警', 'OBJ_COST', 'OBJ_BUDGET',
 ...
 '当累计费用超过预算额度10%时触发预警',
 '["Construction", "Operation"]', 'CRITICAL', 'jicai'),
