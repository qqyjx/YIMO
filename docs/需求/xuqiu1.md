...
![alt text](c6bf0d140a15aeeec65d1737e2bee42e.png)
这是部署在研发环境的服务器的规格

Q:葛总，我需要南网数字平台前端组件库（NPM/SDK）、南网测试服部署环境规格、DeepSeek API内网可达性确认
A:这些库到时候你们要来才能给你们这些包，如果只是部署在研发环境，到时候你们过来下载也行


4.24更新问题：
/home/qq/YIMO/docs/需求/web应用界面设计规范.pdf
/home/qq/YIMO/docs/需求/数字平台科技公司网页端应用界面设计规范.docx
前端界面按照这个规范来修改