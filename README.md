...
|                          数据导入层                                |
+-------------------------------------------------------------------+
|   python scripts/import_all.py --stage planning --source ...      |
|   python scripts/import_all.py --stage design --source ...        |
|   python scripts/import_all.py --stage construction --source ...  |
|   python scripts/import_all.py --stage operation --source ...     |
|   python scripts/import_all.py --stage finance --source ...       |
+--------------------------------+----------------------------------+
                                 v
+-------------------------------------------------------------------+
|                         EAV 存储层                                 |
...
|                       监控与可视化层                               |
+-------------------------------------------------------------------+
|   aiops_consistency_monitor.py -> data_anomalies                  |
|   /lifecycle  -> 统一本体可视化                                    |
|   /anomalies  -> 异常监控面板                                      |
+-------------------------------------------------------------------+
```
