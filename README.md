...
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│   python scripts/import_all.py --stage planning --source 可研报告   │
│   python scripts/import_all.py --stage design --source 设计清单     │
│   python scripts/import_all.py --stage construction --source 施工台账│
